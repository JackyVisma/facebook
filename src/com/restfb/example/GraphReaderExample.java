...
public class GraphReaderExample  {
  ...
  void fetchObject() {
    ...
    Page page = facebookClient25.fetchObject("https://www.facebook.com/search/top/?q=Jacopo+Vismara&init=public", Page.class);
 ...
 // Pull out JSON data by key and map each type by hand.
    ...
    User user = jsonMapper.toJavaObject(results.get("4").toString(), User.class);
